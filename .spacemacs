...
`dotspacemacs/user-config' first."
  ;; better set before load the package
  )
;; read the source code for autocomplete
;;;(defun my-pre-command-for-tab()
;;;  (if this-command)
;;;  (command-execute (symbol-function 'hippie-expand))
;;;  )
...
you should place your code here."
  ...
  (add-hook 'org-mode-hook (lambda()
                             ...
                             (local-set-key "(" 'cdlatex-pbb)
                             (local-set-key "{" 'cdlatex-pbb)
                             (local-set-key (kbd "C-M-/") 'undo-tree-redo)
                             ))   ; with Emacs latex mode
  (global-set-key (kbd "M-.") 'rtags-find-symbol-at-point)
  (global-set-key (kbd "M-,") 'rtags-find-references-at-point)
  (global-set-key (kbd "C-M-.") 'rtags-location-stack-forward)
  (global-set-key (kbd "C-M-,") 'rtags-location-stack-back)
  (global-set-key (kbd "M-;") 'rtags-find-symbol)
  (global-set-key (kbd "C-M-o") 'rtags-find-file)
  ...
  (setq org-todo-keyword-faces
        '(("TODO" . org-warning) ("DOING" . "magenta1")
          ("CANCELED" . (:foreground "blue" :weight bold))))

  (setq-default my-screenshot-dir "~/Pictures")
  ...
  (defun my-org-download-screenshot ()
    (interactive)
    (org-download-image (aj-fetch-latest my-screenshot-dir)))
  (eval-after-load "org"
    '(progn
       (setq org-format-latex-options (plist-put org-format-latex-options :scale 3.0))
       (define-key org-mode-map (kbd "<f5>") 'my-org-download-screenshot)
       (org-defkey org-mode-map [(meta return)] 'org-meta-return)
       (define-key org-mode-map (kbd "C-<tab>") 'cdlatex-tab)
       ))
   ...
   (quote
    (("axm" "Insert axiom env" "" cdlatex-environment
     ...
     ("thr" "Insert theorem env" "" cdlatex-environment
      ("theorem")
      t nil)
     ("eqo" "Insert equation *" "" cdlatex-environment
      ("equation*")
      t nil)
     ("eqno" "Insert equation *" "" cdlatex-environment
      ("eqnarray*")
      t nil)
...
" cdlatex-position-cursor nil t nil)
     ("tt" "Insert \\text" "\\textrm{?}" cdlatex-position-cursor nil nil t))))
 ...
 '(js-indent-level 2)
 '(js2-basic-offset 2)
 '(org-agenda-files (quote ("~/proj/notes/paper/notes.org")))
 '(org-download-image-width 500)
 ...
 '(org-ref-bibliography-notes "~/proj/notes/paper/notes.org")
 '(org-ref-default-bibliography (quote ("~/proj/notes/paper/references.bib")))
 '(org-ref-pdf-directory "~/proj/notes-data/pdfs/")
